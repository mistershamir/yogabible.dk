/**
 * Populate Educational Content — Utility Function
 *
 * Reads email content from data/educational-content.json and updates
...
const content = require('./data/educational-content.json');
...
exports.handler = async (event) => {
  ...
  if (!sequenceId || sequenceId === 'REPLACE_WITH_FIRESTORE_SEQUENCE_ID') {
    return { statusCode: 400, body: JSON.stringify({ error: 'Set sequence_id in educational-content.json' }) };
  }
